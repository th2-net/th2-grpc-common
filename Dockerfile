...
WORKDIR /home/project
COPY ./ .
RUN /home/th2-python-service-generator/bin/th2-python-service-generator -p src/main/proto/grpc_common -w PythonServiceWriter -o src/gen/main/python/grpc_common
