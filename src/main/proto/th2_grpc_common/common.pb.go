...
type MessageMetadata struct {
	...
	Properties    map[string]string      `protobuf:"bytes,4,rep,name=properties,proto3" json:"properties,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // Additional properties for the message
...
type RawMessageMetadata struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            *MessageID             `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`                                                                                           // Message id should be unique in session
	Properties    map[string]string      `protobuf:"bytes,3,rep,name=properties,proto3" json:"properties,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // Additional properties for the raw message
...
func (x *Value) GetSimpleValue() string {
	if x != nil {
		if x, ok := x.Kind.(*Value_SimpleValue); ok {
...
func (x *AnyMessage) GetKind() isAnyMessage_Kind {
	if x != nil {
		return x.Kind
	}
	return nil
...
func (x *AnyMessage) GetMessage() *Message {
	if x != nil {
		if x, ok := x.Kind.(*AnyMessage_Message); ok {
			return x.Message
		}
	}
	return nil
...
func (x *AnyMessage) GetRawMessage() *RawMessage {
	if x != nil {
		if x, ok := x.Kind.(*AnyMessage_RawMessage); ok {
			return x.RawMessage
		}
	}
	return nil
...
func (x *ValueFilter) GetKind() isValueFilter_Kind {
	if x != nil {
		return x.Kind
	}
	return nil
...
func (x *ValueFilter) GetSimpleFilter() string {
	if x != nil {
		if x, ok := x.Kind.(*ValueFilter_SimpleFilter); ok {
...
func (x *ValueFilter) GetMessageFilter() *MessageFilter {
	if x != nil {
		if x, ok := x.Kind.(*ValueFilter_MessageFilter); ok {
...
func (x *ValueFilter) GetListFilter() *ListValueFilter {
	if x != nil {
		if x, ok := x.Kind.(*ValueFilter_ListFilter); ok {
			return x.ListFilter
		}
	}
	return nil
...
func (x *ValueFilter) GetSimpleList() *SimpleList {
	if x != nil {
		if x, ok := x.Kind.(*ValueFilter_SimpleList); ok {
			return x.SimpleList
		}
	}
	return nil
...
func (x *ValueFilter) GetNullValue() NullValue {
	if x != nil {
		if x, ok := x.Kind.(*ValueFilter_NullValue); ok {
			return x.NullValue
		}
	}
	return NullValue_NULL_VALUE
...
type MessageFilter struct {
	state              protoimpl.MessageState  `protogen:"open.v1"`
	Fields             map[string]*ValueFilter `protobuf:"bytes,3,rep,name=fields,proto3" json:"fields,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type MetadataFilter struct {
	state           protoimpl.MessageState                  `protogen:"open.v1"`
	PropertyFilters map[string]*MetadataFilter_SimpleFilter `protobuf:"bytes,1,rep,name=property_filters,json=propertyFilters,proto3" json:"property_filters,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type MetadataFilter_SimpleFilter struct {
	...
	Operation FilterOperation        `protobuf:"varint,1,opt,name=operation,proto3,enum=FilterOperation" json:"operation,omitempty"`
	Key       bool                   `protobuf:"varint,2,opt,name=key,proto3" json:"key,omitempty"`
	// Types that are valid to be assigned to FilterValue:
	//
...
func (x *MetadataFilter_SimpleFilter) GetFilterValue() isMetadataFilter_SimpleFilter_FilterValue {
	if x != nil {
...
func (x *MetadataFilter_SimpleFilter) GetValue() string {
	if x != nil {
		if x, ok := x.FilterValue.(*MetadataFilter_SimpleFilter_Value); ok {
			return x.Value
		}
	}
	return ""
...
func (x *MetadataFilter_SimpleFilter) GetSimpleList() *SimpleList {
	if x != nil {
		if x, ok := x.FilterValue.(*MetadataFilter_SimpleFilter_SimpleList); ok {
			return x.SimpleList
		}
	}
	return nil
...
type Checkpoint_SessionAliasToDirectionCheckpoint struct {
	state                             protoimpl.MessageState                     `protogen:"open.v1"`
	SessionAliasToDirectionCheckpoint map[string]*Checkpoint_DirectionCheckpoint `protobuf:"bytes,1,rep,name=session_alias_to_direction_checkpoint,json=sessionAliasToDirectionCheckpoint,proto3" json:"session_alias_to_direction_checkpoint,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields                     protoimpl.UnknownFields
	sizeCache                         protoimpl.SizeCache
}
...
type Checkpoint_DirectionCheckpoint struct {
	state                     protoimpl.MessageState               `protogen:"open.v1"`
	DirectionToCheckpointData map[int32]*Checkpoint_CheckpointData `protobuf:"bytes,2,rep,name=direction_to_checkpoint_data,json=directionToCheckpointData,proto3" json:"direction_to_checkpoint_data,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
var file_th2_grpc_common_common_proto_rawDesc = string([]byte{
	...
	0x10, 0x00, 0x12, 0x0a, 0x0a, 0x06, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x01, 0x42, 0x63,
	...
	0x5a, 0x41, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x68, 0x32,
	0x2d, 0x6e, 0x65, 0x74, 0x2f, 0x74, 0x68, 0x32, 0x2d, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x63, 0x6f,
	0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x73, 0x72, 0x63, 0x2f, 0x6d, 0x61, 0x69, 0x6e, 0x2f, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x2f, 0x74, 0x68, 0x32, 0x5f, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x63, 0x6f, 0x6d,
	0x6d, 0x6f, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
})

var (
	file_th2_grpc_common_common_proto_rawDescOnce sync.Once
	file_th2_grpc_common_common_proto_rawDescData []byte
)

func file_th2_grpc_common_common_proto_rawDescGZIP() []byte {
	file_th2_grpc_common_common_proto_rawDescOnce.Do(func() {
		file_th2_grpc_common_common_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_th2_grpc_common_common_proto_rawDesc), len(file_th2_grpc_common_common_proto_rawDesc)))
	})
...
var file_th2_grpc_common_common_proto_goTypes = []any{
...
func file_th2_grpc_common_common_proto_init() {
	...
	file_th2_grpc_common_common_proto_msgTypes[6].OneofWrappers = []any{
		(*Value_NullValue)(nil),
		(*Value_SimpleValue)(nil),
		(*Value_MessageValue)(nil),
		(*Value_ListValue)(nil),
	}
	file_th2_grpc_common_common_proto_msgTypes[10].OneofWrappers = []any{
		(*AnyMessage_Message)(nil),
		(*AnyMessage_RawMessage)(nil),
	}
	file_th2_grpc_common_common_proto_msgTypes[18].OneofWrappers = []any{
	...
	file_th2_grpc_common_common_proto_msgTypes[32].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_th2_grpc_common_common_proto_rawDesc), len(file_th2_grpc_common_common_proto_rawDesc)),
			NumEnums:      6,
			NumMessages:   40,
			NumExtensions: 0,
			NumServices:   0,
